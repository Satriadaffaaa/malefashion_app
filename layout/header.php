            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="header__nav__option">
                        ...
                        <a href="../shopping-cart.php"><img src="img/icon/cart.png" alt=""> <span><?php if(isset($_SESSION['quantity']) && $_SESSION['quantity'] != 0) { echo $_SESSION['quantity']; } ?></span></a>
                        <div class="price"><?php if(isset($_SESSION['total']) && $_SESSION['total'] != 0) { echo setRupiah(($_SESSION['total'] * $kurs_dollar)); } ?></div>
                    </div>
                </div>
            </div>
